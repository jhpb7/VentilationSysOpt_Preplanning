...
Code utilised for publication "*Optimal Ventilation Systems via MILP: Duct Sizing, Fan Placement, Control Strategies*", Breuer and Pelz.  
...
```
pip install git+https://github.com/jhpb7/VentilationSysOpt_Preplanning
```
